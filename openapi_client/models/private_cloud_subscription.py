...
class PrivateCloudSubscription(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrivateCloudSubscription:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrivateCloudSubscription:
        """Create an instance of PrivateCloudSubscription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrivateCloudSubscription.parse_obj(obj)

        _obj = PrivateCloudSubscription.parse_obj({
