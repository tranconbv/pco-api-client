...
class WhitelistCreate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WhitelistCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WhitelistCreate:
        """Create an instance of WhitelistCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WhitelistCreate.parse_obj(obj)

        _obj = WhitelistCreate.parse_obj({
