...
class PrivateCloudCloudSize(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrivateCloudCloudSize:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrivateCloudCloudSize:
        """Create an instance of PrivateCloudCloudSize from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrivateCloudCloudSize.parse_obj(obj)

        _obj = PrivateCloudCloudSize.parse_obj({
