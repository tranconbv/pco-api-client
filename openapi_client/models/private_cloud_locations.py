...
class PrivateCloudLocations(BaseModel):
    """
    ...
    ike_version: Optional[PrivateCloudLocationsIKEVersion] = Field(None, alias="IKE_Version")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrivateCloudLocations:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrivateCloudLocations:
        """Create an instance of PrivateCloudLocations from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrivateCloudLocations.parse_obj(obj)

        _obj = PrivateCloudLocations.parse_obj({
            "location": obj.get("Location"),
            "status": obj.get("Status"),
            "whitelist": obj.get("Whitelist"),
            "ike_version": PrivateCloudLocationsIKEVersion.from_dict(obj.get("IKE_Version")) if obj.get("IKE_Version") is not None else None,
